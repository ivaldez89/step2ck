      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/wellness" className="text-slate-400 hover:text-teal-400 transition-colors text-sm">Wellness Center</Link></li>
              <li><Link href="/impact" className="text-slate-400 hover:text-teal-400 transition-colors text-sm">How Impact Works</Link></li>
              <li><Link href="/tribes" className="text-slate-400 hover:text-teal-400 transition-colors text-sm">Tribes & Community</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-2 text-sm">
                ...
                <Link href="/support" className="text-slate-400 hover:text-teal-400 transition-colors">Help & Support</Link>
              </li>
              <li className="flex items-center gap-2 text-sm">
                ...
                <Link href="/feedback" className="text-slate-400 hover:text-teal-400 transition-colors">Send Feedback</Link>
              </li>
              <li className="flex items-center gap-2 text-sm">
                <svg className="w-4 h-4 text-teal-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                <Link href="/faq" className="text-slate-400 hover:text-teal-400 transition-colors">FAQ</Link>
              </li>
            </ul>
            <div className="mt-6">
